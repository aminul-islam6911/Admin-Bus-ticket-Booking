...
import com.example.adminbusticketbookingsystem.Model.TicketModel;
...
public class TicketActivity extends AppCompatActivity {
    private TextView start, des, busNo, traveller, date, user;
    private String stUser, stGetSeats, stDateId, stBusNo, stTravellerNo, stStart, stDestination, stDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference query = FirebaseDatabase.getInstance().getReference().child("Tickets").child("Admin").child(date_ref);
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<TicketModel, TicketAdapter>(options) {
            ...
            protected void onBindViewHolder(@NonNull TicketAdapter holder, @SuppressLint("RecyclerView") final int position, @NonNull TicketModel model) {
                ...
                holder.txtUser.setText("User :" + model.getUser());
                ...
                holder.tCancel.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        user = view.findViewById(R.id.cUser);
                        ...
                        cancel.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                FirebaseDatabase.getInstance().getReference().child("Tickets").child("Users").child(stUser)
                                ...
                                seatUpdate();
                                Toast.makeText(TicketActivity.this, "ticket canceled successfully", Toast.LENGTH_SHORT).show();
